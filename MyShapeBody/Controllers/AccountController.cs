                ...
                if (result.Succeeded)
                {
                    ...
                    var html = @"<html>
                                    <body style='font-weight:bold;color:black;'>
                                     ...
                                     <br/>
                                     <p>MyBodyShape team.</p>
                                     <img alt='Logo' title='MyBodyShape' src='cid:mybodyshapelogo' />
                                    </body>
                                   </html>";
                    var mail = mailNotificator.Send(html, model.Email, model.Email.Split('@')[0], "Welcome on My BodyShape");
